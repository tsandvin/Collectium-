...
export const allDemoUsers: AdminUser[] = [
  ...
  ...moreUsers.map((raw, idx): AdminUser => {
    ...
    return {
      ...
      supportFlag: idx % 5 === 0 ? "Support bÃ¸r kontrollere siste filterfeil" : "Ingen aktiv sak",
